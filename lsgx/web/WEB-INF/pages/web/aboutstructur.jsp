    	...
    	<section>
        	<div class="about-intro-main">
            	<div class="about-intro-left">
                    ...
                    <div class="intleft-conn">
                    	<ul>
                            ...
                            <li><a class="active" href="/aboutstructur.do">基金会组织结构</a></li>
            	...
            	<div class="about-intro-right">
                	<div class="intright-title">基金会组织结构</div>
                	<div class="intright-stru">
                    	<img class="stru-img" src="image/about-struc.png" />
                    </div>
                </div>
            </div>
