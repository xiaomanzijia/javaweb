...
<div class="pageContent">
	<form method="post" action="/loveStory/editLoveStory.do" class="pageForm required-validate" rel="" onsubmit="return iframeCallback(this, dialogAjaxDone);">
	  ...
	  <input type="hidden" name=news_column value="${newsVO.news_column }" />
		<div class="pageFormContent" layoutH="57">
			...
			<div class="unit">
				...
				<input name="abstracts" type="text" size="26" value="${newsVO.abstracts }" maxlength="30" remote="act_Master_validateName.html" />
