...
<div class="pageHeader">
	<form id="pagerForm" method="post" action="/loveStory/diseaseList.do">
	...
	<div class="searchBar">
		<form method="post" rel="pagerForm" action="/loveStory/diseaseList.do" onsubmit="return navTabSearch(this)">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<!-- 权限 -->
			<priveliege:enable buttonCode="diseaseAdd">
				<li><a class="add" href="/loveStory/diseaseSend.do" target="dialog" rel="diseaseAdd" title="疾病信息发布" mask=true width="680" height="480"><span>疾病信息发布</span></a></li>
			</priveliege:enable>
		</ul>
	</div>
		...
		<tbody>
			<c:forEach  items="${news}" var="news">
				<tr target="list_item_id" rel="${news.id }">
					...
					<td style="width:100px">
					<priveliege:enable buttonCode="diseaseEdit">
				    <a class="btnEdit" href="/loveStory/diseaseEdit.do?id=${news.id}" target="dialog" rel="diseaseEdit" title="修改"mask="true" maxable="false" resizable="false" drawable="true"  width="680" height="480"><span>修改</span></a>
					</priveliege:enable>
					<priveliege:enable buttonCode="diseaseDelete">
					<a class="btnDel" href="/loveStory/diseaseDelete.do?id=${news.id}" target="ajaxTodo" rel="diseaseDelete" title="删除"><span>删除</span></a></li>
					</priveliege:enable>
					</td>
				</tr>
			</c:forEach>
