...
<div class="pageContent">
	<form method="post" action="/helpStudy/buildSchoolSend.do" class="pageForm required-validate" rel="" onsubmit="return iframeCallback(this, dialogAjaxDone);">	
		<div class="pageFormContent nowrap" layoutH="57">
            ...
            <div class="unit">
                ...
                <input class="textInput" value="${main_column }" readonly="readonly" style="width:80px" id="news_column" name="news_column"  type="text">
                <label style="width:50px">二级栏目</label>
                <input class="textInput" value="${sub_column }" readonly="readonly" style="width:70px" id="sub_column" name="sub_column"  type="text">	
                <label style="width:50px">三级栏目</label>
                <input class="textInput" value="${third_column }" readonly="readonly" style="width:70px" id="third_column" name="third_column"  type="text">			
            </div>
            <div class="unit">
