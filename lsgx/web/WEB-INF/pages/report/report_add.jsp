...
<div class="pageContent">
	...
	<form method="post" action="report/addReport.do" class="pageForm required-validate"  
		...
		<div class="pageFormContent" layoutH="57">
			<div class="unit">
				<label>内容:</label>
				<textarea name="content"  maxlength="50" class="required" rows="12" cols="60"></textarea>
			</div>
		</div>
		<div class="formBar">
			<ul>
