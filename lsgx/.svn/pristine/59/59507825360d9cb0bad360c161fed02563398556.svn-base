    	...
    	<header>
            ...
            <div class="share-nav">
                <ul class="shnav_left">
                    ...
                    <li><a class="active" href="/disclosure.do">信息批露</a></li>
    	...
    	<section>
        	<div class="about-intro-main">
            	<div class="about-intro-left">
                	<div class="intleft-title">信息披露</div>
                    <div class="intleft-conn">
                        <ul>
                            <li><a  href="/disclosure.do">项目动态</a></li>
                            <li><a class="active" href="/disclosuremedia.do">媒体报道</a></li>
                            <li><a href="/disclosurereport.do">审计报告</a></li>
                        </ul>
                    </div>
                </div>
            	<div class="about-dynamic-right">
                	<div class="dynright-title">媒体报道</div>
