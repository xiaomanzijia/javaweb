...
<div class="pageHeader">
	<form id="pagerForm" method="post" action="/article/queryList.do">
	...
	<div class="searchBar">
		<form method="post" rel="pagerForm" action="/news/newsList.do" onsubmit="return navTabSearch(this)">
	...
	<div class="panelBar">
		<ul class="toolBar">
			...
			<priveliege:enable buttonCode="newsAdd">
				<li><a class="add" href="/news/newsSend.do" target="dialog" rel="newsAdd" title="新闻公告发布" mask=true width="680" height="480"><span>新闻公告发布</span></a></li>
			</priveliege:enable>
		</ul>
	</div>
		...
		<tbody>
			<c:forEach  items="${news}" var="news">
				<tr target="list_item_id" rel="${news.id }">
				    ...
				    <a class="btnEdit" href="/news/newsEdit.do?id=${news.id}" target="dialog" rel="newsEdit" title="修改"mask="true" maxable="false" resizable="false" drawable="true"  width="680" height="480"><span>修改</span></a>
					</priveliege:enable>
					<priveliege:enable buttonCode="newsDelete">
					<a class="btnDel" href="/news/newsDelete.do?id=${news.id}" target="ajaxTodo" rel="newsDelete" title="删除"><span>删除</span></a></li>
					</priveliege:enable>
					</td>
				</tr>
			</c:forEach>
