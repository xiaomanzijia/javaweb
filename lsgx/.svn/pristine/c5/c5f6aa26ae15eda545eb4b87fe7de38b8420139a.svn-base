...
<div class="pageContent">
	<form method="post" action="/loveStory/loveStorySend.do" class="pageForm required-validate" rel="" onsubmit="return iframeCallback(this, dialogAjaxDone);">	
		<div class="pageFormContent nowrap" layoutH="57">
            ...
            <div class="unit">
				<label style="width:30px">来源</label>
			...
			<div class="unit">
                ...
                <textarea name="content" class="editor required" rows="12" cols="100"></textarea>
			</div>
		</div>
		<div class="formBar">
			<ul>
