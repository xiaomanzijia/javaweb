...
<div class="pageContent">
	<form method="post" enctype="multipart/form-data" action="article/articleAdd.do" class="pageForm required-validate" rel="" onsubmit="return iframeCallback(this, dialogAjaxDone);">
		...
		<div class="pageFormContent" layoutH="57">
			...
			<div class="unit">
				<label>封面图片(宽度126像素，高度83像素)</label>
