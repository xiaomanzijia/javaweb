...
<div class="pageHeader">
	<form id="pagerForm" method="post" action="/loveStory/studyHelpList.do">
	...
	<div class="searchBar">
		<form method="post" rel="pagerForm" action="/loveStory/studyHelpList.do" onsubmit="return navTabSearch(this)">
	...
	<div class="panelBar">
		<ul class="toolBar">
			...
			<priveliege:enable buttonCode="studyHelpAdd">
				<li><a class="add" href="/loveStory/studyHelpSend.do" target="dialog" rel="studyHelpAdd" title="助学信息发布" mask=true width="680" height="480"><span>助学信息发布</span></a></li>
			</priveliege:enable>
		</ul>
	</div>
		...
		<tbody>
			<c:forEach  items="${news}" var="news">
				<tr target="list_item_id" rel="${news.id }">
				    ...
				    <a class="btnEdit" href="/loveStory/studyHelpEdit.do?id=${news.id}" target="dialog" rel="studyHelpEdit" title="修改"mask="true" maxable="false" resizable="false" drawable="true"  width="680" height="480"><span>修改</span></a>
					</priveliege:enable>
					<priveliege:enable buttonCode="studyHelpDelete">
					<a class="btnDel" href="/loveStory/studyHelpDelete.do?id=${news.id}" target="ajaxTodo" rel="studyHelpDelete" title="删除"><span>删除</span></a></li>
					</priveliege:enable>
					</td>
				</tr>
			</c:forEach>
