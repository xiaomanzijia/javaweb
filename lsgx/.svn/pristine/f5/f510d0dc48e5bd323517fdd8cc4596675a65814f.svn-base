...
<div class="pageContent">
	<form method="post" action="/news/newsSend.do" class="pageForm required-validate" rel="" onsubmit="return iframeCallback(this, dialogAjaxDone);">	
		<div class="pageFormContent nowrap" layoutH="57">
            ...
            <div class="unit">
                ...
                <input class="textInput" value="${news_column }" readonly="readonly" style="width:150px" id="news_column" name="news_column"  type="text">
            </div>
            <div class="unit">
