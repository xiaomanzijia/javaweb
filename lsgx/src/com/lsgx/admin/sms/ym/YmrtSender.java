...
import com.lsgx.admin.sms.SmsSender;


public class YmrtSender implements SmsSender
{
    ...
    {
        YmrtSender ym = new YmrtSender();
        ym.init();
        
        StringBuilder sb = new StringBuilder();
        sb.append("您的校验码为：17593，请在10分钟内完成验证。如非本人操作，请致电客服");
        
        boolean ret = ym.send(new String[] {"18510065860"}, sb.toString(), 5);
